...
- Code Security
  - Concepts
    - Code Scanning
      - Codeql
        ...
        * [Code QL Query Packs](code-security/concepts/code-scanning/codeql/codeql-query-packs.md)
        * [Code QL Query Suites](code-security/concepts/code-scanning/codeql/codeql-query-suites.md)
        * [Custom Code QL Queries](code-security/concepts/code-scanning/codeql/custom-codeql-queries.md)
      ...
      * [Code Scanning Alert Tracking Using Issues](code-security/concepts/code-scanning/code-scanning-alert-tracking-using-issues.md)
    ...
    - Secret Security
      ...
      * [About Validity Checks](code-security/concepts/secret-security/about-validity-checks.md)
    ...
    - Supply Chain Security
      ...
      * [About Dependabot Pull Requests](code-security/concepts/supply-chain-security/about-dependabot-pull-requests.md)
  ...
  - How Tos
    - Find And Fix Code Vulnerabilities
      - Configure Code Scanning
        ...
        * [Configuring Default Setup For Code Scanning](code-security/how-tos/find-and-fix-code-vulnerabilities/configure-code-scanning/configuring-default-setup-for-code-scanning.md)
      ...
      - Integrate With Existing Tools
        ...
        * [Uploading A SARIF File To Git Hub](code-security/how-tos/find-and-fix-code-vulnerabilities/integrate-with-existing-tools/uploading-a-sarif-file-to-github.md)
        * [Using Code Scanning With Your Existing CI System](code-security/how-tos/find-and-fix-code-vulnerabilities/integrate-with-existing-tools/using-code-scanning-with-your-existing-ci-system.md)
      - Manage Your Configuration
        * [Code QL Code Scanning For Compiled Languages](code-security/how-tos/find-and-fix-code-vulnerabilities/manage-your-configuration/codeql-code-scanning-for-compiled-languages.md)
        * [Configuring Larger Runners For Default Setup](code-security/how-tos/find-and-fix-code-vulnerabilities/manage-your-configuration/configuring-larger-runners-for-default-setup.md)
        * [Editing Your Configuration Of Default Setup](code-security/how-tos/find-and-fix-code-vulnerabilities/manage-your-configuration/editing-your-configuration-of-default-setup.md)
        * [Manage Your Configuration](code-security/how-tos/find-and-fix-code-vulnerabilities/manage-your-configuration/index.md)
        * [Set Code Scanning Merge Protection](code-security/how-tos/find-and-fix-code-vulnerabilities/manage-your-configuration/set-code-scanning-merge-protection.md)
      ...
      - Scan From The Command Line
        ...
        * [Specifying Command Options In A Code QL Configuration File](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-the-command-line/specifying-command-options-in-a-codeql-configuration-file.md)
        * [Testing Custom Queries](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-the-command-line/testing-custom-queries.md)
        * [Testing Query Help Files](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-the-command-line/testing-query-help-files.md)
      ...
      - Scan From Vs Code
        ...
        * [Managing The Code QL CLI In The VS Code Extension](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/configuring-access-to-the-codeql-cli.md)
        * [Creating A Custom Query](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/creating-a-custom-query.md)
        * [Customizing Settings](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/customizing-settings.md)
        * [Exploring Data Flow With Path Queries](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/exploring-data-flow-with-path-queries.md)
        * [Exploring The Structure Of Your Source Code](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/exploring-the-structure-of-your-source-code.md)
        * [Scan From VS Code](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/index.md)
        * [Installing Code QL For Visual Studio Code](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/installing-codeql-for-vs-code.md)
        * [Managing Code QL Databases](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/managing-codeql-databases.md)
        ...
        * [Running Code QL Queries At Scale With Multi Repository Variant Analysis](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/running-codeql-queries-at-scale-with-multi-repository-variant-analysis.md)
        ...
        * [Setting Up A Code QL Workspace](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/setting-up-a-codeql-workspace.md)
        ...
        * [Using The Code QL Model Editor](code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/using-the-codeql-model-editor.md)
    ...
    - Manage Security Alerts
      - Manage Code Scanning Alerts
        * [Assessing Code Scanning Alerts For Your Repository](code-security/how-tos/manage-security-alerts/manage-code-scanning-alerts/assessing-code-scanning-alerts-for-your-repository.md)
        ...
        * [Enabling Delegated Alert Dismissal For Code Scanning](code-security/how-tos/manage-security-alerts/manage-code-scanning-alerts/enabling-delegated-alert-dismissal-for-code-scanning.md)
        * [Manage Code Scanning Alerts](code-security/how-tos/manage-security-alerts/manage-code-scanning-alerts/index.md)
        * [Linking Code Scanning Alerts To Git Hub Issues](code-security/how-tos/manage-security-alerts/manage-code-scanning-alerts/linking-code-scanning-alerts-to-github-issues.md)
        * [Resolving Code Scanning Alerts](code-security/how-tos/manage-security-alerts/manage-code-scanning-alerts/resolving-code-scanning-alerts.md)
        * [Triaging Code Scanning Alerts In Pull Requests](code-security/how-tos/manage-security-alerts/manage-code-scanning-alerts/triaging-code-scanning-alerts-in-pull-requests.md)
      ...
      - Manage Secret Scanning Alerts
        * [Enabling Delegated Alert Dismissal For Secret Scanning](code-security/how-tos/manage-security-alerts/manage-secret-scanning-alerts/enabling-delegated-alert-dismissal-for-secret-scanning.md)
    ...
    - Report And Fix Vulnerabilities
      - Configure Vulnerability Reporting
        * [Adding A Security Policy To Your Repository](code-security/how-tos/report-and-fix-vulnerabilities/configure-vulnerability-reporting/adding-a-security-policy-to-your-repository.md)
        * [Configuring Private Vulnerability Reporting For A Repository](code-security/how-tos/report-and-fix-vulnerabilities/configure-vulnerability-reporting/configuring-private-vulnerability-reporting-for-a-repository.md)
      ...
      - Fix Reported Vulnerabilities
        * [Adding A Collaborator To A Repository Security Advisory](code-security/how-tos/report-and-fix-vulnerabilities/fix-reported-vulnerabilities/adding-a-collaborator-to-a-repository-security-advisory.md)
        * [Browsing Security Advisories In The Git Hub Advisory Database](code-security/how-tos/report-and-fix-vulnerabilities/fix-reported-vulnerabilities/browsing-security-advisories-in-the-github-advisory-database.md)
        * [Creating A Repository Security Advisory](code-security/how-tos/report-and-fix-vulnerabilities/fix-reported-vulnerabilities/creating-a-repository-security-advisory.md)
        * [Deleting A Repository Security Advisory](code-security/how-tos/report-and-fix-vulnerabilities/fix-reported-vulnerabilities/deleting-a-repository-security-advisory.md)
        * [Editing A Repository Security Advisory](code-security/how-tos/report-and-fix-vulnerabilities/fix-reported-vulnerabilities/editing-a-repository-security-advisory.md)
        * [Editing Security Advisories In The Git Hub Advisory Database](code-security/how-tos/report-and-fix-vulnerabilities/fix-reported-vulnerabilities/editing-security-advisories-in-the-github-advisory-database.md)
    ...
    - Secure Your Secrets
      - Customize Leak Detection
        * [Defining Custom Patterns For Secret Scanning](code-security/how-tos/secure-your-secrets/customize-leak-detection/defining-custom-patterns-for-secret-scanning.md)
        * [Enabling Extended Metadata Checks For Your Repository](code-security/how-tos/secure-your-secrets/customize-leak-detection/enabling-extended-metadata-checks-for-your-repository.md)
        * [Enabling Validity Checks For Your Repository](code-security/how-tos/secure-your-secrets/customize-leak-detection/enabling-validity-checks-for-your-repository.md)
        * [Excluding Folders And Files From Secret Scanning](code-security/how-tos/secure-your-secrets/customize-leak-detection/excluding-folders-and-files-from-secret-scanning.md)
        ...
        * [Managing Custom Patterns](code-security/how-tos/secure-your-secrets/customize-leak-detection/managing-custom-patterns.md)
      - Detect Secret Leaks
        ...
        * [Enabling Secret Scanning For Your Repository](code-security/how-tos/secure-your-secrets/detect-secret-leaks/enabling-secret-scanning-for-your-repository.md)
  ...
  - Reference
    ...
    - Code Scanning
      - Codeql
        ...
        - Codeql Queries
          * [About Built In Code QL Queries](code-security/reference/code-scanning/codeql/codeql-queries/about-built-in-queries.md)
      ...
      - Sarif Files
        ...
        * [SARIF Support For Code Scanning](code-security/reference/code-scanning/sarif-files/sarif-support-for-code-scanning.md)
      - Troubleshoot Analysis Errors
        ...
        * [Cannot Enable Code QL In A Private Repository](code-security/reference/code-scanning/troubleshoot-analysis-errors/cannot-enable-codeql-in-a-private-repository.md)
        * [Enabling Default Setup Takes Too Long](code-security/reference/code-scanning/troubleshoot-analysis-errors/enabling-default-setup-takes-too-long.md)
  ...
  - Tutorials
    ...
    - Customize Code Scanning
      * [Analyzing Your Code With Code QL Queries](code-security/tutorials/customize-code-scanning/analyzing-your-code-with-codeql-queries.md)
