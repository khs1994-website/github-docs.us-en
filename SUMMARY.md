...
- Actions
  - Concepts
    ...
    * [About Actions Policies](actions/concepts/about-actions-policies.md)
  ...
  - How Tos
    - Administer
      * [Controlling who can execute {% data variables.product.prodname_actions %} workflows](actions/how-tos/administer/control-workflow-execution.md)
...
- Code Security
    ...
    - Code Scanning
      - Codeql
        ...
        - Codeql Cli Manual
          ...
          * [Resolve Library Paths](code-security/reference/code-scanning/codeql/codeql-cli-manual/resolve-library-paths.md)
  ...
  - Tutorials
    ...
    * [Improve Code Quality At Scale With Git Hub](code-security/tutorials/code-quality-adoption-path.md)
...
- Copilot
  - Concepts
    ...
    - Enterprise
      ...
      * [MCP Server Usage In Your Company](copilot/concepts/enterprise/mcp-management.md)
      * [Open Telemetry For Agent Monitoring](copilot/concepts/enterprise/opentelemetry.md)
      * [About Enterprise Managed Plugin Standards](copilot/concepts/enterprise/plugin-standards.md)
      * [Git Hub Copilot Policies For Enterprises And Organizations](copilot/concepts/enterprise/policies.md)
    - Models
    ...
    - Administer Copilot
      - Manage For Enterprise
        ...
        - Use Managed Settings
          * [Using Enterprise Managed Settings Without Organizations](copilot/how-tos/administer-copilot/manage-for-enterprise/use-managed-settings/copilot-business-only.md)
          * [Choosing How To Deploy Enterprise Managed Settings To Users](copilot/how-tos/administer-copilot/manage-for-enterprise/use-managed-settings/deploy-managed-settings.md)
          * [Getting Started With Enterprise Managed Settings](copilot/how-tos/administer-copilot/manage-for-enterprise/use-managed-settings/get-started.md)
          * [Using Enterprise Managed Settings For Git Hub Copilot](copilot/how-tos/administer-copilot/manage-for-enterprise/use-managed-settings/index.md)
          * [Overriding Enterprise Managed Settings For Teams](copilot/how-tos/administer-copilot/manage-for-enterprise/use-managed-settings/override-settings-for-teams.md)
      ...
      - Manage Mcp Usage
        * [Configuring An MCP Server Allowlist For Your Enterprise](copilot/how-tos/administer-copilot/manage-mcp-usage/configure-enterprise-allowlist.md)
  ...
  - Reference
    ...
    - Enterprise Administrators
      ...
      * [MCP Private Registry Enforcement](copilot/reference/enterprise-administrators/mcp-private-registry-enforcement.md)
  ...
  - Tutorials
    ...
    * [Optimize Git Hub Copilot Chat Context To Reduce AI Credit Usage](copilot/tutorials/optimize-chat-usage.md)
...
- Nonprofit
  ...
  - Project Pods
    * [Creating A Project Pod For Volunteer Groups](nonprofit/project-pods/index.md)
    * [Frequently Asked Questions](nonprofit/project-pods/frequently-asked-questions.md)
  - Troubleshooting
...
- Pull Requests
  - Concepts
    * [Deploying Code](pull-requests/concepts/deploying-code.md)
    * [Giving Reviews](pull-requests/concepts/giving-reviews.md)
    * [Helping Others Review Your Changes](pull-requests/concepts/helping-others-review-your-changes.md)
    * [Concepts For Pull Requests](pull-requests/concepts/index.md)
    * [Resolving Reviews](pull-requests/concepts/resolving-reviews.md)
    * [Writing Code For A Project](pull-requests/concepts/writing-code-for-a-project.md)
  - Get Started
  ...
  - How Tos
    - Commit Changes
      ...
      * [Committing Changes To A Pull Request Branch Created From A Fork](pull-requests/how-tos/commit-changes/committing-changes-to-a-pull-request-branch-created-from-a-fork.md)
      * [Comparing Commits](pull-requests/how-tos/commit-changes/comparing-commits.md)
      * [Creating A Commit With Multiple Authors Or On Behalf Of An Organization](pull-requests/how-tos/commit-changes/creating-a-commit-with-multiple-authors.md)
      * [Commit Changes](pull-requests/how-tos/commit-changes/index.md)
      * [Managing Branches Within Your Repository](pull-requests/how-tos/commit-changes/managing-branches-within-your-repository.md)
      * [Troubleshooting Commits](pull-requests/how-tos/commit-changes/troubleshooting-commits.md)
    - Create Pull Requests
      * [Changing The Base Branch Of A Pull Request](pull-requests/how-tos/create-pull-requests/changing-the-base-branch-of-a-pull-request.md)
    ...
    - Merge And Close Pull Requests
      ...
      * [Closing A Pull Request](pull-requests/how-tos/merge-and-close-pull-requests/closing-a-pull-request.md)
    ...
    - Review Pull Requests
      ...
      * [Commenting On A Pull Request](pull-requests/how-tos/review-pull-requests/commenting-on-a-pull-request.md)
      * [Dismissing A Pull Request Review](pull-requests/how-tos/review-pull-requests/dismissing-a-pull-request-review.md)
      * [Incorporating Feedback In Your Pull Request](pull-requests/how-tos/review-pull-requests/incorporating-feedback-in-your-pull-request.md)
    ...
    - Work With Forks
      ...
      * [Detaching A Fork](pull-requests/how-tos/work-with-forks/detaching-a-fork.md)
      * [Fork A Repository](pull-requests/how-tos/work-with-forks/fork-a-repo.md)
      * [Work With Forks](pull-requests/how-tos/work-with-forks/index.md)
      * [Syncing A Fork](pull-requests/how-tos/work-with-forks/syncing-a-fork.md)
    * [How Tos For Pull Requests](pull-requests/how-tos/index.md)
  - Reference
    * [Branches](pull-requests/reference/branches.md)
    * [Commits](pull-requests/reference/commits.md)
    * [Forks](pull-requests/reference/forks.md)
    * [Reference For Pull Requests](pull-requests/reference/index.md)
    * [Managing And Standardizing Pull Requests](pull-requests/reference/managing-and-standardizing-pull-requests.md)
    * [Merge Conflicts](pull-requests/reference/merge-conflicts.md)
...
- [Rest](rest/README.md)
  ...
  - Actions
    ...
    * [REST API Endpoints For Git Hub Actions Policies](rest/actions/policies.md)
  ...
  - Enterprise Admin
    ...
    * [REST API Endpoints For Enterprise Live Migrations](rest/enterprise-admin/live-migrations.md)
