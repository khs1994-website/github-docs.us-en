...
- Billing
  ...
  - How Tos
    - Manage For Client
      ...
      * [Upgrading Or Downgrading Your Client S Paid Organization](billing/how-tos/manage-for-client/manage-client-org.md)
...
- Copilot
  - Concepts
    ...
    - Coding Agent
      * [About Copilot Coding Agent](copilot/concepts/coding-agent/coding-agent.md)
      * [About enabling {% data variables.copilot.copilot_coding_agent %}](copilot/concepts/coding-agent/enable-coding-agent.md)
      * [Concepts for {% data variables.copilot.copilot_coding_agent %}](copilot/concepts/coding-agent/index.md)
      * [Model Context Protocol (MCP) and {% data variables.copilot.copilot_coding_agent %}](copilot/concepts/coding-agent/mcp-and-coding-agent.md)
    - Completions
    ...
    - Extensions
      * [About Copilot Extensions](copilot/concepts/extensions/about-extensions.md)
      * [About Agents For Copilot Extensions](copilot/concepts/extensions/agents.md)
      * [Git Hub Copilot Extensions](copilot/concepts/extensions/index.md)
      * [Open ID Connect OIDC For Copilot Extensions](copilot/concepts/extensions/openid-connect.md)
      * [About Skillsets For Copilot Extensions](copilot/concepts/extensions/skillsets.md)
    ...
    * [Copilot Knowledge Bases](copilot/concepts/knowledge-bases.md)
    ...
    * [Prompt Engineering For Copilot Chat](copilot/concepts/prompt-engineering.md)
    * [Rate Limits For Git Hub Copilot](copilot/concepts/rate-limits.md)
    * [Indexing Repositories For Copilot Chat](copilot/concepts/repository-indexes.md)
    * [About Customizing Git Hub Copilot Chat Responses](copilot/concepts/response-customization.md)
    * [About Organizing And Sharing Context With Copilot Spaces](copilot/concepts/spaces.md)
  - Get Started
  ...
  - How Tos
    - Administer Copilot
      - Manage For Enterprise
        ...
        - Manage Plan
          * [Canceling Copilot For Your Enterprise](copilot/how-tos/administer-copilot/manage-for-enterprise/manage-plan/cancel-plan.md)
          * [Downgrading Copilot For Your Enterprise](copilot/how-tos/administer-copilot/manage-for-enterprise/manage-plan/downgrade-subscription.md)
          * [Managing The Copilot Plan For Your Enterprise](copilot/how-tos/administer-copilot/manage-for-enterprise/manage-plan/index.md)
          * [Subscribing To Copilot For Your Enterprise](copilot/how-tos/administer-copilot/manage-for-enterprise/manage-plan/subscribe.md)
          * [Upgrading Copilot For Your Enterprise](copilot/how-tos/administer-copilot/manage-for-enterprise/manage-plan/upgrade-plan.md)
        * [Managing Git Hub Copilot In Your Enterprise](copilot/how-tos/administer-copilot/manage-for-enterprise/index.md)
        * [Managing {% data variables.copilot.copilot_coding_agent %} in your enterprise](copilot/how-tos/administer-copilot/manage-for-enterprise/manage-copilot-coding-agent.md)
        * [Managing Policies And Features For Copilot In Your Enterprise](copilot/how-tos/administer-copilot/manage-for-enterprise/manage-enterprise-policies.md)
      - Manage For Organization
        - Manage Access
          * [Granting Access To Copilot For Members Of Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/manage-access/grant-access.md)
          ...
          * [Managing Requests For Copilot Business In Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/manage-access/manage-requests-for-access.md)
          * [Revoking Access To Copilot For Members Of Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/manage-access/revoke-access.md)
        - Manage Plan
          * [Canceling Copilot For Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/manage-plan/cancel.md)
          * [Managing The Copilot Plan For Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/manage-plan/index.md)
          * [Subscribing To Copilot For Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/manage-plan/subscribe.md)
        - Review Activity
          ...
          * [Reviewing Audit Logs For Copilot Business](copilot/how-tos/administer-copilot/manage-for-organization/review-activity/review-audit-logs.md)
          * [Reviewing User Activity Data For Copilot In Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/review-activity/review-user-activity-data.md)
        * [Adding {% data variables.copilot.copilot_coding_agent %} to your organization](copilot/how-tos/administer-copilot/manage-for-organization/add-copilot-coding-agent.md)
        * [Managing Git Hub Copilot In Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/index.md)
        * [Managing Policies And Features For Copilot In Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/manage-policies.md)
        * [Setting Permissions For A Copilot Extension In Your Organization](copilot/how-tos/administer-copilot/manage-for-organization/set-extension-permissions.md)
      * [Downloading A Copilot Activity Report For Your Organization Or Enterprise](copilot/how-tos/administer-copilot/download-activity-report.md)
    ...
    - Get Code Suggestions
      ...
      * [Writing pull request descriptions with {% data variables.copilot.copilot_autocomplete_pr %}](copilot/how-tos/get-code-suggestions/write-pr-descriptions.md)
    - Manage And Track Spending
      * [Manage And Monitor Spending For Copilot](copilot/how-tos/manage-and-track-spending/index.md)
      ...
      * [Monitoring Your Copilot Usage And Entitlements](copilot/how-tos/manage-and-track-spending/monitor-premium-requests.md)
    - Manage Your Account
      * [Disabling Git Hub Copilot Free](copilot/how-tos/manage-your-account/disable-copilot-free.md)
      * [Getting Free Access To Copilot Pro As A Student Teacher Or Maintainer](copilot/how-tos/manage-your-account/get-free-access-to-copilot-pro.md)
      * [Getting Started With A Copilot Plan](copilot/how-tos/manage-your-account/get-started-with-a-copilot-plan.md)
      * [Manage Your Git Hub Copilot Account](copilot/how-tos/manage-your-account/index.md)
      * [Managing Copilot Policies As An Individual Subscriber](copilot/how-tos/manage-your-account/manage-policies.md)
      * [Viewing And Changing Your Copilot Plan](copilot/how-tos/manage-your-account/view-and-change-your-copilot-plan.md)
    - Provide Context
      - Install Copilot Extensions
        ...
        * [Using Extensions To Integrate External Tools With Copilot Chat](copilot/how-tos/provide-context/install-copilot-extensions/use-copilot-extensions.md)
      - Use Copilot Spaces
        * [Collaborating With Your Team Using Copilot Spaces](copilot/how-tos/provide-context/use-copilot-spaces/collaborate-with-your-team.md)
        * [Creating And Using Copilot Spaces](copilot/how-tos/provide-context/use-copilot-spaces/create-and-use-copilot-spaces.md)
        * [Copilot Spaces](copilot/how-tos/provide-context/use-copilot-spaces/index.md)
      - Use Mcp
        * [Extending Copilot Chat With The Model Context Protocol MCP](copilot/how-tos/provide-context/use-mcp/extend-copilot-chat-with-mcp.md)
      ...
      * [Creating And Managing Copilot Knowledge Bases](copilot/how-tos/provide-context/create-knowledge-bases.md)
    ...
    - Use Ai Models
      * [Changing The AI Model For Copilot Chat](copilot/how-tos/use-ai-models/change-the-chat-model.md)
      * [Changing The AI Model For Copilot Code Completion](copilot/how-tos/use-ai-models/change-the-completion-model.md)
      * [Configuring Access To AI Models In Copilot](copilot/how-tos/use-ai-models/configure-access-to-ai-models.md)
      * [Creating A Custom Model For Git Hub Copilot](copilot/how-tos/use-ai-models/create-a-custom-model.md)
      * [AI Models For Copilot](copilot/how-tos/use-ai-models/index.md)
    - Use Chat
      * [Getting Started With Prompts For Copilot Chat](copilot/how-tos/use-chat/get-started-with-chat.md)
      * [Copilot Chat](copilot/how-tos/use-chat/index.md)
    ...
    - Use Copilot Agents
      - Coding Agent
        * [Using Copilot To Work On An Issue](copilot/how-tos/use-copilot-agents/coding-agent/assign-copilot-to-an-issue.md)
        * [Asking Copilot To Create A Pull Request](copilot/how-tos/use-copilot-agents/coding-agent/create-a-pr.md)
        * [Customizing The Development Environment For Copilot Coding Agent](copilot/how-tos/use-copilot-agents/coding-agent/customize-the-agent-environment.md)
        * [Customizing Or Disabling The Firewall For Copilot Coding Agent](copilot/how-tos/use-copilot-agents/coding-agent/customize-the-agent-firewall.md)
        * [Extending Copilot Coding Agent With The Model Context Protocol MCP](copilot/how-tos/use-copilot-agents/coding-agent/extend-coding-agent-with-mcp.md)
        * [{% data variables.copilot.copilot_coding_agent %}](copilot/how-tos/use-copilot-agents/coding-agent/index.md)
        * [Reviewing A Pull Request Created By Copilot](copilot/how-tos/use-copilot-agents/coding-agent/review-copilot-prs.md)
        * [Tracking Copilot S Sessions](copilot/how-tos/use-copilot-agents/coding-agent/track-copilot-sessions.md)
        * [Troubleshooting Copilot Coding Agent](copilot/how-tos/use-copilot-agents/coding-agent/troubleshoot-coding-agent.md)
      - Request A Code Review
        * [Configuring Automatic Code Review By Copilot](copilot/how-tos/use-copilot-agents/request-a-code-review/configure-automatic-review.md)
    ...
    - Use Copilot Extensions
      - Build A Copilot Agent
        * [Configuring Your Copilot Agent To Communicate With The Copilot Platform](copilot/how-tos/use-copilot-extensions/build-a-copilot-agent/communicate-with-copilot-platform.md)
        * [Configuring Your Copilot Agent To Communicate With Git Hub](copilot/how-tos/use-copilot-extensions/build-a-copilot-agent/communicate-with-github.md)
        * [Building A Copilot Agent For Your Copilot Extension](copilot/how-tos/use-copilot-extensions/build-a-copilot-agent/index.md)
        * [Context Passing For Your Agent](copilot/how-tos/use-copilot-extensions/build-a-copilot-agent/use-context-passing.md)
        * [Using Copilot S LLM For Your Agent](copilot/how-tos/use-copilot-extensions/build-a-copilot-agent/use-copilots-llm.md)
      - Build A Copilot Skillset
        * [Building Copilot Skillsets](copilot/how-tos/use-copilot-extensions/build-a-copilot-skillset/build-copilot-skillsets.md)
        * [Building A Copilot Skillset For Your Copilot Extension](copilot/how-tos/use-copilot-extensions/build-a-copilot-skillset/index.md)
      - Create A Copilot Extension
        * [Configuring Your Git Hub App For Your Copilot Extension](copilot/how-tos/use-copilot-extensions/create-a-copilot-extension/configure-app-for-extension.md)
        * [Creating A Git Hub App For Your Copilot Extension](copilot/how-tos/use-copilot-extensions/create-a-copilot-extension/create-github-app.md)
        * [Configuring Your Server To Host Your Copilot Extension](copilot/how-tos/use-copilot-extensions/create-a-copilot-extension/host-your-extension.md)
        * [Creating A Copilot Extension](copilot/how-tos/use-copilot-extensions/create-a-copilot-extension/index.md)
      * [Debugging Your Git Hub Copilot Extension](copilot/how-tos/use-copilot-extensions/debug-copilot-extension.md)
      * [Copilot Extensions](copilot/how-tos/use-copilot-extensions/index.md)
      * [Managing The Availability Of Your Copilot Extension](copilot/how-tos/use-copilot-extensions/manage-extension-availability.md)
      * [Setting Up Copilot Extensions](copilot/how-tos/use-copilot-extensions/set-up-copilot-extensions.md)
    ...
    - Use Copilot For Common Tasks
      ...
      * [Use Copilot For Common Tasks](copilot/how-tos/use-copilot-for-common-tasks/index.md)
  ...
  - Reference
    - Ai Models
      ...
      * [Hosting Of Models For Copilot Chat](copilot/reference/ai-models/model-hosting.md)
      * [Supported AI Models In Copilot](copilot/reference/ai-models/supported-models.md)
    - Copilot Billing
      * [Copilot Billing Through Azure](copilot/reference/copilot-billing/azure-billing.md)
      * [Copilot Billing Cycle](copilot/reference/copilot-billing/billing-cycle.md)
      * [Copilot Billing](copilot/reference/copilot-billing/index.md)
      * [Making Changes To Your Copilot License](copilot/reference/copilot-billing/license-changes.md)
      * [Copilot Seat Assignment](copilot/reference/copilot-billing/seat-assignment.md)
    ...
    * [Copilot Extensions Glossary](copilot/reference/extensions-glossary.md)
    ...
    * [Feature Availability When Copilot Policies Conflict In Organizations](copilot/reference/policy-conflicts.md)
  - Responsible Use
    ...
    * [Responsible use of Copilot coding agent on GitHub.com](copilot/responsible-use/copilot-coding-agent.md)
  ...
  - Tutorials
    - Coding Agent
      * [Best Practices For Using Copilot To Work On Tasks](copilot/tutorials/coding-agent/get-the-best-results.md)
      * [{% data variables.copilot.copilot_coding_agent %}](copilot/tutorials/coding-agent/index.md)
      * [Piloting {% data variables.copilot.copilot_coding_agent %} in your organization](copilot/tutorials/coding-agent/pilot-coding-agent.md)
    ...
    - Roll Out At Scale
      ...
      - Enable Developers
        * [Driving Copilot Adoption In Your Company](copilot/tutorials/roll-out-at-scale/enable-developers/drive-adoption.md)
      ...
      - Measure Adoption
        * [Analyzing Usage Over Time With The Copilot Metrics API](copilot/tutorials/roll-out-at-scale/measure-adoption/analyze-usage-over-time.md)
    ...
    * [Enhancing Copilot Agent Mode With MCP](copilot/tutorials/enhance-agent-mode-with-mcp.md)
    * [Using Copilot To Explore A Codebase](copilot/tutorials/explore-a-codebase.md)
    * [Using Copilot To Explore Issues And Discussions](copilot/tutorials/explore-issues-and-discussions.md)
    * [Using Copilot To Explore Pull Requests](copilot/tutorials/explore-pull-requests.md)
    ...
    * [Using Copilot To Migrate A Project To Another Programming Language](copilot/tutorials/migrate-a-project.md)
    ...
    * [Speeding Up Development Work With Copilot Spaces](copilot/tutorials/speed-up-development-work.md)
