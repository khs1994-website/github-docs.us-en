...
- Actions
  - Concepts
    ...
    - Runners
      ...
      * [Private Networking With Git Hub Hosted Runners](actions/concepts/runners/private-networking-with-github-hosted-runners.md)
      ...
      * [Support For Actions Runner Controller](actions/concepts/runners/support-for-actions-runner-controller.md)
    - Security
  ...
  - How Tos
    ...
    - Creating And Publishing Actions
      * [Creating A Third Party CLI Action](actions/how-tos/creating-and-publishing-actions/creating-a-third-party-cli-action.md)
      * [Creating And Publishing Actions](actions/how-tos/creating-and-publishing-actions/index.md)
      * [Managing Custom Actions](actions/how-tos/creating-and-publishing-actions/managing-custom-actions.md)
      * [Publishing Actions In Git Hub Marketplace](actions/how-tos/creating-and-publishing-actions/publishing-actions-in-github-marketplace.md)
      * [Releasing And Maintaining Actions](actions/how-tos/creating-and-publishing-actions/releasing-and-maintaining-actions.md)
      * [Setting Exit Codes For Actions](actions/how-tos/creating-and-publishing-actions/setting-exit-codes-for-actions.md)
    - Managing Self Hosted Runners
      * [Adding Self Hosted Runners](actions/how-tos/managing-self-hosted-runners/adding-self-hosted-runners.md)
      * [Configuring The Self Hosted Runner Application As A Service](actions/how-tos/managing-self-hosted-runners/configuring-the-self-hosted-runner-application-as-a-service.md)
      * [Customizing The Containers Used By Jobs](actions/how-tos/managing-self-hosted-runners/customizing-the-containers-used-by-jobs.md)
      * [Managing Self Hosted Runners](actions/how-tos/managing-self-hosted-runners/index.md)
      * [Managing Access To Self Hosted Runners Using Groups](actions/how-tos/managing-self-hosted-runners/managing-access-to-self-hosted-runners-using-groups.md)
      * [Monitoring And Troubleshooting Self Hosted Runners](actions/how-tos/managing-self-hosted-runners/monitoring-and-troubleshooting-self-hosted-runners.md)
      * [Removing Self Hosted Runners](actions/how-tos/managing-self-hosted-runners/removing-self-hosted-runners.md)
      * [Running Scripts Before Or After A Job](actions/how-tos/managing-self-hosted-runners/running-scripts-before-or-after-a-job.md)
      * [Using A Proxy Server With Self Hosted Runners](actions/how-tos/managing-self-hosted-runners/using-a-proxy-server-with-self-hosted-runners.md)
      * [Using Labels With Self Hosted Runners](actions/how-tos/managing-self-hosted-runners/using-labels-with-self-hosted-runners.md)
      * [Using Self Hosted Runners In A Workflow](actions/how-tos/managing-self-hosted-runners/using-self-hosted-runners-in-a-workflow.md)
    - Managing Workflow Runs And Deployments
      ...
      - Managing Workflow Runs
        * [Approving Workflow Runs From Forks](actions/how-tos/managing-workflow-runs-and-deployments/managing-workflow-runs/approving-workflow-runs-from-forks.md)
  ...
  - Reference
    ...
    * [Workflow Cancellation Reference](actions/reference/workflow-cancellation-reference.md)
  ...
  - Tutorials
    ...
    - Project Management
      * [Adding Labels To Issues](actions/tutorials/project-management/adding-labels-to-issues.md)
      * [Closing Inactive Issues](actions/tutorials/project-management/closing-inactive-issues.md)
      * [Commenting On An Issue When A Label Is Added](actions/tutorials/project-management/commenting-on-an-issue-when-a-label-is-added.md)
      * [Managing Projects](actions/tutorials/project-management/index.md)
      * [Scheduling Issue Creation](actions/tutorials/project-management/scheduling-issue-creation.md)
    - Publishing Packages
    ...
    - Using Containerized Services
      * [Creating A Docker Container Action](actions/tutorials/using-containerized-services/creating-a-docker-container-action.md)
      * [Creating Postgre SQL Service Containers](actions/tutorials/using-containerized-services/creating-postgresql-service-containers.md)
      * [Creating Redis Service Containers](actions/tutorials/using-containerized-services/creating-redis-service-containers.md)
      * [Using Containerized Services](actions/tutorials/using-containerized-services/index.md)
...
- Copilot
  - Concepts
    ...
    - Copilot Billing
      ...
      * [About Billing For Git Hub Spark](copilot/concepts/copilot-billing/about-billing-for-github-spark.md)
      ...
      * [Requests In Git Hub Copilot](copilot/concepts/copilot-billing/requests-in-github-copilot.md)
    ...
    * [About Git Hub Copilot Chat](copilot/concepts/about-github-copilot-chat.md)
  ...
  - How Tos
    ...
    - Context
      ...
      * [Using Knowledge Bases](copilot/how-tos/context/using-knowledge-bases.md)
    - Custom Instructions
    ...
    - Github Flow
      ...
      * [Use Copilot For Common Tasks](copilot/how-tos/github-flow/index.md)
  ...
  - Responsible Use Of Github Copilot Features
    ...
    * [Responsible Use Of Git Hub Spark](copilot/responsible-use-of-github-copilot-features/responsible-use-of-github-spark.md)
  - Tutorials
    - Copilot Chat Cookbook
      - Debugging Errors
        ...
        * [Debug Errors](copilot/tutorials/copilot-chat-cookbook/debugging-errors/index.md)
      - Documenting Code
        ...
        * [Document Code](copilot/tutorials/copilot-chat-cookbook/documenting-code/index.md)
      ...
      - Functionality Analysis And Feature Suggestions
        ...
        * [Analyze Functionality](copilot/tutorials/copilot-chat-cookbook/functionality-analysis-and-feature-suggestions/index.md)
      - Refactoring Code
        ...
        * [Refactor Code](copilot/tutorials/copilot-chat-cookbook/refactoring-code/index.md)
      ...
      - Security Analysis
        ...
        * [Analyze Security](copilot/tutorials/copilot-chat-cookbook/security-analysis/index.md)
      ...
      - Testing Code
        * [Creating End To End Tests For A Webpage](copilot/tutorials/copilot-chat-cookbook/testing-code/creating-end-to-end-tests-for-a-webpage.md)
        * [Creating Mock Objects To Abstract Layers](copilot/tutorials/copilot-chat-cookbook/testing-code/creating-mock-objects-to-abstract-layers.md)
    ...
    * [Building And Deploying AI Powered Apps With Git Hub Spark](copilot/tutorials/building-ai-app-prototypes.md)
    * [Building Your First App In Minutes With Git Hub Spark](copilot/tutorials/building-your-first-app-in-minutes-with-github-spark.md)
    ...
    * [Piloting Copilot Coding Agent In Your Organization](copilot/tutorials/pilot-copilot-coding-agent.md)
    ...
    * [Using Copilot To Explore Issues And Discussions](copilot/tutorials/using-copilot-to-explore-issues-and-discussions.md)
    * [Using Copilot To Explore Pull Requests](copilot/tutorials/using-copilot-to-explore-pull-requests.md)
